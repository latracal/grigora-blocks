...
return array(
	...
	'inserter'   => true,
	'content'    => '
	<!-- wp:group {"style":{"spacing":{"padding":{"top":"5%","right":"5%","bottom":"5%","left":"5%"}},"color":{"gradient":"linear-gradient(135deg,rgb(0,166,252) 0%,rgb(241,0,255) 95%)"}},"className":"mountain"} -->
	<div class="wp-block-group mountain has-background" style="background:linear-gradient(135deg,rgb(0,166,252) 0%,rgb(241,0,255) 95%);padding-top:5%;padding-right:5%;padding-bottom:5%;padding-left:5%"><!-- wp:columns {"className":"hero-block-2"} -->
