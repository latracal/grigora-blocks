...
return array(
	'title'      => esc_html__( 'Columns with circular images', 'grigora' ),
	...
	'content'    => '
		...
		<p class="has-text-align-center">' . esc_html_x( 'Sample content. Replace the text with your own content.', 'sample content', 'grigora' ) . '</p>
		<!-- /wp:paragraph --></div>
		<!-- /wp:column -->
		<!-- wp:column -->
