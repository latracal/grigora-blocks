...
return array(
	...
	'inserter'   => true,
	'content'    => '
	<!-- wp:cover {"align":"full","overlayColor":"primary","isDark":false} -->
	<div class="wp-block-cover is-light alignfull"><span aria-hidden="true" class="has-primary-background-color has-background-dim-100 wp-block-cover__gradient-background has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:columns {"className":"hero-block-2"} -->
