...
return array(
	...
	'content'    => '
		...
		<!-- /wp:heading -->
		<!-- wp:paragraph {"align":"center"} --><p class="has-text-align-center">' . __( 'The page you requested does not exist or has moved. Maybe try a search?', 'grigora' ) . '</p><!-- /wp:paragraph -->
