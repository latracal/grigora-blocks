...
return array(
	...
	'inserter'   => true,
	'content'    => '
	<!-- wp:cover {"url":"'.esc_url( get_theme_file_uri( 'assets/images/hero10cover.jpg' ) ).'","id":2531,"dimRatio":0,"focalPoint":{"x":"0.87","y":"0.65"},"minHeight":50,"minHeightUnit":"vh","align":"full","className":"grigora-hero","style":{"spacing":{"padding":{"top":"3%","right":"8%","bottom":"0%","left":"8%"}}}} -->
	<div class="wp-block-cover alignfull grigora-hero" style="padding-top:3%;padding-right:8%;padding-bottom:0%;padding-left:8%;min-height:50vh"><span aria-hidden="true" class="has-background-dim-0 wp-block-cover__gradient-background has-background-dim"></span><img class="wp-block-cover__image-background wp-image-2531" alt="" src="http://localhost/latracal/wp-content/themes/grigora-fse/assets/images/hero10cover.jpg" style="object-position:87% 65%" data-object-fit="cover" data-object-position="87% 65%"/><div class="wp-block-cover__inner-container"><!-- wp:columns {"verticalAlignment":"top"} -->
	...
	<div class="wp-block-image"><figure class="aligncenter size-full"><img src="http://localhost/latracal/wp-content/themes/grigora-fse/assets/images/hero10featured.png" alt="" class="wp-image-2530"/></figure></div>
	<!-- /wp:image --></div>
	<!-- /wp:column --></div>
	<!-- /wp:columns --></div>
	<!-- /wp:column --></div>
