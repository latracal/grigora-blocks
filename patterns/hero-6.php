...
return array(
	...
	'inserter'   => true,
	'content'    => '
	<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"10%","right":"8%","bottom":"10%","left":"8%"}}},"className":"background_3"} -->
	<div class="wp-block-group alignfull background_3" style="padding-top:10%;padding-right:8%;padding-bottom:10%;padding-left:8%"><!-- wp:columns {"verticalAlignment":"top"} -->
	...
	<div class="wp-block-columns hero-block-2"><!-- wp:column {"width":"45%"} -->
	<div class="wp-block-column" style="flex-basis:45%"><!-- wp:paragraph {"align":"center","textColor":"background"} -->
