...
return array(
	...
	'inserter'   => true,
	'content'    => '
	<!-- wp:cover {"overlayColor":"black","contentPosition":"center center","align":"full","className":"grigora-hero","style":{"spacing":{"padding":{"top":"0%","right":"8%","bottom":"8%","left":"8%"}}}} -->
<div class="wp-block-cover alignfull grigora-hero" style="padding-top:0%;padding-right:8%;padding-bottom:8%;padding-left:8%"><span aria-hidden="true" class="has-black-background-color has-background-dim-100 wp-block-cover__gradient-background has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:template-part {"slug":"transparent-header","theme":"grigora-blocks"} /-->

<!-- wp:columns {"verticalAlignment":"top"} -->
<div class="wp-block-columns are-vertically-aligned-top"><!-- wp:column {"style":{"spacing":{"padding":{"top":"8%"}}}} -->
<div class="wp-block-column" style="padding-top:8%"><!-- wp:columns -->
