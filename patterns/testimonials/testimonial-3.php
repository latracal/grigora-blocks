...
return array(
	...
	<div class="wp-block-image" style="border-radius:50%"><figure class="aligncenter size-full is-resized"><img src="https://wpgrigora.com/blocks/wp-content/assets/images/testimonial/face1.png" alt="" width="200" height="200" /></figure></div>
	<!-- /wp:image -->
	...
	<div class="wp-block-image" style="border-radius:50%"><figure class="aligncenter size-large is-resized"><img src="https://wpgrigora.com/blocks/wp-content/assets/images/testimonial/face2.png" alt="" width="200" height="200" /></figure></div>
	<!-- /wp:image -->
	...
	<!-- wp:column {"style":{"spacing":{"padding":{"top":"2%","right":"2%","bottom":"2%","left":"2%"}},"color":{"background":"#2c3447"}},"className":"background-image"} -->
	<div class="wp-block-column background-image has-background" style="background-color:#2c3447;padding-top:2%;padding-right:2%;padding-bottom:2%;padding-left:2%"><!-- wp:image {"align":"center","width":200,"height":200,"sizeSlug":"large","style":{"border":{"radius":"50%"}}} -->
	<div class="wp-block-image" style="border-radius:50%"><figure class="aligncenter size-large is-resized"><img src="https://wpgrigora.com/blocks/wp-content/assets/images/testimonial/face3.png" alt="" width="200" height="200" /></figure></div>
	<!-- /wp:image -->
