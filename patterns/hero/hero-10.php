...
return array(
	...
	'inserter'   => true,
	'content'    => '
	<!-- wp:cover {"url":"https://wpgrigora.com/blocks/wp-content/assets/images/hero/clouds.jpg","dimRatio":0,"focalPoint":{"x":"0.87","y":"0.65"},"minHeight":50,"minHeightUnit":"vh","isDark":false,"align":"full","className":"grigora-hero hero-10","style":{"spacing":{"padding":{"top":"3%","right":"8%","bottom":"0%","left":"8%"}}}} -->
	<div class="wp-block-cover alignfull is-light grigora-hero hero-10" style="padding-top:3%;padding-right:8%;padding-bottom:0%;padding-left:8%;min-height:50vh"><span aria-hidden="true" class="has-background-dim-0 wp-block-cover__gradient-background has-background-dim"></span><img class="wp-block-cover__image-background" alt="" src="https://wpgrigora.com/blocks/wp-content/assets/images/hero/clouds.jpg" style="object-position:87% 65%" data-object-fit="cover" data-object-position="87% 65%"/><div class="wp-block-cover__inner-container"><!-- wp:columns -->
