        ...
        if( isset($block['blockName']) && isset($block['attrs']['className']) && !empty($block['attrs']['className']) ){
            ...
            // columns
                ...
                if (str_contains($block['attrs']['className'], 'is-style-columns-no-gap') !== false) {
                    grigora_blocks_render_inline_styles("grigora-used-styles", ".is-style-columns-no-gap{gap:0 !important}");
                }
            }
            // column
            else if ($block['blockName'] == 'core/column') {
                if (str_contains($block['attrs']['className'], 'is-style-grigora-shadow') !== false) {
                    grigora_blocks_render_inline_styles("grigora-used-styles", ".is-style-grigora-shadow{box-shadow:0 4px 4px 0 rgba(0,0,0,.2)}");
                }
                else if (str_contains($block['attrs']['className'], 'is-style-grigora-border') !== false) {
                    grigora_blocks_render_inline_styles("grigora-used-styles", ".is-style-grigora-border{border:1px solid gray}");
                }
                else if (str_contains($block['attrs']['className'], 'is-style-grigora-shadow-border') !== false) {
                    grigora_blocks_render_inline_styles("grigora-used-styles", ".is-style-grigora-shadow-border{box-shadow:0 4px 4px 0 rgba(0,0,0,.2);border:1px solid gray}");
                }
                else if (str_contains($block['attrs']['className'], 'is-style-grigora-border-rounded') !== false) {
                    grigora_blocks_render_inline_styles("grigora-used-styles", ".is-style-grigora-border-rounded{border:1px solid gray;border-radius:4px}");
                }
                else if (str_contains($block['attrs']['className'], 'is-style-grigora-shadow-rounded') !== false) {
                    grigora_blocks_render_inline_styles("grigora-used-styles", ".is-style-grigora-shadow-rounded{box-shadow:0 4px 4px 0 rgba(0,0,0,.2);border-radius:4px}");
                }
                else if (str_contains($block['attrs']['className'], 'is-style-grigora-shadow-border-rounded') !== false) {
                    grigora_blocks_render_inline_styles("grigora-used-styles", ".is-style-grigora-shadow-border-rounded{box-shadow:0 4px 4px 0 rgba(0,0,0,.2);border:1px solid currentColor;border-radius:4px}");
                }
            ...
            // heading
                ...
                if (str_contains($block['attrs']['className'], 'is-style-grigora-heading-1') !== false) {
                    ...
                    grigora_blocks_render_inline_styles("grigora-used-styles", ".is-style-no-text-decoration *{text-decoration:none}");
                }
            }
            // post title
            ...
            // query pagination
                ...
                if (str_contains($block['attrs']['className'], 'is-style-grigora-query-pagination-buttons') !== false) {
                    grigora_blocks_render_inline_styles("grigora-used-styles", ".is-style-grigora-query-pagination-buttons .wp-block-query-pagination-next,.is-style-grigora-query-pagination-buttons .wp-block-query-pagination-previous{text-decoration:none;background-color:#eee;padding:.1rem .5rem;border-radius:4px}");
                }
            }
            // navigation
            else if ($block['blockName'] == 'core/navigation') {
                if (str_contains($block['attrs']['className'], 'is-style-grigora-navigation-style-1') !== false) {
                    grigora_blocks_render_inline_styles("grigora-used-styles", ".is-style-grigora-navigation-style-1 .wp-block-navigation:not([style*=text-decoration]) a:focus{color:#fff}.is-style-grigora-navigation-style-1 .wp-block-navigation__container{justify-content:center}.is-style-grigora-navigation-style-1 .wp-block-navigation__container li{padding:.5rem 1rem;transition:all .2s;border-radius:4px}.is-style-grigora-navigation-style-1 .wp-block-navigation__container li a:hover{color:#fff}.is-style-grigora-navigation-style-1 .wp-block-navigation__container li:hover{background-color:#ec4138}.is-style-grigora-navigation-style-1 .wp-block-navigation__container li:hover a{color:#fff}.is-style-grigora-navigation-style-1 .wp-block-navigation__container li:hover svg{stroke:#fff;transform:rotate(180deg)}.is-style-grigora-navigation-style-1 .wp-block-navigation__container li .wp-block-navigation__submenu-container li{border-radius:0}.is-style-grigora-navigation-style-1 .wp-block-navigation__container li .wp-block-navigation__submenu-container li a{color:currentColor}.is-style-grigora-navigation-style-1 .wp-block-navigation__container li .wp-block-navigation__submenu-container li a:hover{color:#fff}.is-style-grigora-navigation-style-1 .wp-block-navigation__container li .wp-block-navigation__submenu-container li:hover a{color:#fff}.is-style-grigora-navigation-style-1 .wp-block-navigation__container li .wp-block-navigation__submenu-container li svg{transform:rotate(270deg)}.is-style-grigora-navigation-style-1 .wp-block-navigation__container li .wp-block-navigation__submenu-container li .wp-block-navigation__submenu-container li{border-radius:0}.is-style-grigora-navigation-style-1 .wp-block-navigation__container li .wp-block-navigation__submenu-container li .wp-block-navigation__submenu-container li a{color:currentColor}.is-style-grigora-navigation-style-1 .wp-block-navigation__container li .wp-block-navigation__submenu-container li .wp-block-navigation__submenu-container li a:hover{color:#fff}");
                }
            }
            // post author
            else if ($block['blockName'] == 'core/post-author') {
                if (str_contains($block['attrs']['className'], 'is-style-grigora-post-author-style-1') !== false) {
                    grigora_blocks_render_inline_styles("grigora-used-styles", ".is-style-grigora-post-author-style-1 img{border-radius:50%}");
                }
            }
            // navigation link
            else if ($block['blockName'] == 'core/navigation-link') {
                if (str_contains($block['attrs']['className'], 'is-style-custom-link-button') !== false) {
                    grigora_blocks_render_inline_styles("grigora-used-styles", ".is-style-custom-link-button span{background-color:var(--wp--preset--color--button);color:var(--wp--preset--color--buttontext);padding:8px 20px 8px 20px !important;border-radius:100px;-webkit-box-shadow:var(--wp--custom--button-shadow);box-shadow:var(--wp--custom--button-shadow);transition:all .3s ease 0s}.is-style-custom-link-button span:hover{filter:brightness(94%) !important}");
                }
            }
            // site title
            else if ($block['blockName'] == 'core/no-underline') {
                if (str_contains($block['attrs']['className'], 'is-style-no-underline') !== false) {
                    grigora_blocks_render_inline_styles("grigora-used-styles", ".is-style-no-underline a{text-decoration:none}.is-style-no-underline a:hover{filter:brightness(94%) !important}");
                }
            }
            // group
            else if ($block['blockName'] == 'core/group') {
                if (str_contains($block['attrs']['className'], 'is-style-hover-shadow') !== false) {
                    grigora_blocks_render_inline_styles("grigora-used-styles", ".is-style-hover-shadow{transition:.3s ease-in-out}.is-style-hover-shadow:hover{box-shadow:rgba(100,100,111,.2) 0px 7px 29px 0px}");
                }
                else if (str_contains($block['attrs']['className'], 'is-style-hover-elevate') !== false) {
                    grigora_blocks_render_inline_styles("grigora-used-styles", ".is-style-hover-elevate{transition:.3s ease-in-out}.is-style-hover-elevate:hover{transform:translateY(-10px);box-shadow:rgba(0,0,0,.35) 0px 5px 15px}");
                }
                else if (str_contains($block['attrs']['className'], 'is-style-grigora-shadow-type-2') !== false) {
                    grigora_blocks_render_inline_styles("grigora-used-styles", ".is-style-grigora-shadow-type-2{box-shadow:rgba(100,100,111,.2) 0px 7px 29px 0px}");
                }
            }
            // cover
            else if ($block['blockName'] == 'core/cover') {
                if (str_contains($block['attrs']['className'], 'is-style-cover-image-zoom') !== false) {
                    grigora_blocks_render_inline_styles("grigora-used-styles", ".is-style-cover-image-zoom{overflow:hidden}.is-style-cover-image-zoom .wp-block-cover__image-background{transition:.3s all ease-in-out}.is-style-cover-image-zoom:hover .wp-block-cover__image-background{transform:scale(1.1)}");
                }
            }
            // image
            else if ($block['blockName'] == 'core/image') {
                if (str_contains($block['attrs']['className'], 'is-style-image-image-zoom') !== false) {
                    grigora_blocks_render_inline_styles("grigora-used-styles", ".is-style-image-image-zoom{overflow:hidden}.is-style-image-image-zoom img{transition:.3s all ease-in-out}.is-style-image-image-zoom:hover img{transform:scale(1.1)}");
                }
                else if (str_contains($block['attrs']['className'], 'is-style-image-border') !== false) {
                    grigora_blocks_render_inline_styles("grigora-used-styles", ".is-style-image-border{border-radius:100%;border:10px solid var(--wp--preset--color--background)}");
                }
            }
            // search
            else if ($block['blockName'] == 'core/search') {
                if (str_contains($block['attrs']['className'], 'is-style-transparent-background') !== false) {
                    grigora_blocks_render_inline_styles("grigora-used-styles", ".is-style-transparent-background{background-color:var(--wp--custom--small-button-transparent)}.is-style-transparent-background input{color:inherit;background-color:inherit;border:1px solid currentColor}.is-style-transparent-background input::placeholder{color:inherit;opacity:.6}");
                }
            }
            return $block_content;
        }
