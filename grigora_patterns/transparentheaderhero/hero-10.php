 ...
 * 
 * Title: Person Showcase Transparent Header
 * Slug: grigora/transparentheaderhero/hero-10
...
return array(
	...
	'inserter'   => true,
	'content'    => '
	<!-- wp:cover {"url":"'. esc_url( get_theme_file_uri( "assets/images/hero/clouds.jpg" ) ) .'","dimRatio":0,"focalPoint":{"x":"0.87","y":"0.65"},"minHeight":50,"minHeightUnit":"vh","isDark":false,"align":"full","className":"grigora-hero hero-10","style":{"spacing":{"padding":{"top":"0%","right":"0%","bottom":"0%","left":"0%"}}}} -->
	<div class="wp-block-cover alignfull is-light grigora-hero hero-10" style="padding-top:0%;padding-right:0%;padding-bottom:0%;padding-left:0%;min-height:50vh"><span aria-hidden="true" class="has-background-dim-0 wp-block-cover__gradient-background has-background-dim"></span><img class="wp-block-cover__image-background" alt="" src="'. esc_url( get_theme_file_uri( "assets/images/hero/clouds.jpg" ) ) .'" style="object-position:87% 65%" data-object-fit="cover" data-object-position="87% 65%"/><div class="wp-block-cover__inner-container"><!-- wp:template-part {"slug":"transparent-header","theme":"grigora-blocks"} /-->
